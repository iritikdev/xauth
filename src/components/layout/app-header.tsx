        ...
        <div className="relative z-10 container mx-auto flex items-center justify-between px-5 md:px-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <Sheet>
              ...
              <SheetContent side="right" className="w-[75%] max-w-sm p-0 border-none bg-[#1c3320] text-white z-[100]">
                

                {/* Mobile Links */}
                <div className="px-6 py-10 space-y-8 h-full overflow-y-auto pb-28">
                  <div className="space-y-3">
                    <p className="text-[10px] font-black text-white/20 uppercase tracking-widest px-2 mb-4">Main Menu</p>
                    {NAV_LINKS.map((link) => (
                  ...
                  <div className="space-y-4 pt-6 border-t border-white/10">
                    <p className="text-[10px] font-black text-white/20 uppercase tracking-widest px-2 mb-4">Account Access</p>
                    {session ? (
                      <SheetClose asChild>
