...
export default function WalletPage() {
  const [data, setData] = useState<
    { balance: number; transactions: any[] } | null | undefined
  >(null);
      ...
      >
        <div className="relative z-10 flex flex-col h-full justify-between">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-[10px] font-black uppercase tracking-[0.3em] text-emerald-400 mb-1 italic">
                Amaze Swadeshi Balance
              </p>
              ...
              data.transactions.map((t) => {
                ...
                return (
                  <TransactionRow
                    ...
                    title={t.description}
                    date={formattedDate}
                    time={formattedTime} // Added new prop
...
function TransactionRow({ title, date, time, amount, type, status }: any) {
  return (
        ...
        <div>
          ...
          <div className="flex items-center gap-2 mt-1">
            ...
            <p className="text-[9px] font-bold text-slate-400 uppercase">
              {date} <span className="mx-1 text-slate-300">•</span> {time}
            </p>
            <span
              className={cn(
